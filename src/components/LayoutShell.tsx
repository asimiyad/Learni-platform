...
export function LayoutShell({
  ...
  return (
    <>
      ...
      {/* Mobile header */}
      <header className="md:hidden fixed top-0 left-0 right-0 flex items-center justify-between h-16 bg-surface border-b border-outline-variant z-30 px-4">
      ...
      <main className="mt-16 md:ml-[280px] min-h-[calc(100vh-4rem)]" style={{ padding: "32px" }}>
